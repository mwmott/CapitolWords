...
dronets= sll_cw_timeseries("drone","1996-01-01","2013-11-22", key="b1884b38a7e04ffeb9bdc91a0a63fe1b")
#134 records returned
dronests= sll_cw_timeseries("drones","1996-01-01","2013-11-22", key="b1884b38a7e04ffeb9bdc91a0a63fe1b")
...
#to see whether they stopped? Also, not sure how to have drones + drone. This is drone.
sll_cw_entity_phrases(entity="legislator",phrase='drone',sort="count", key="b1884b38a7e04ffeb9bdc91a0a63fe1b")
#Drones
sll_cw_entity_phrases(entity="legislator",phrase='drones',sort="count", key="b1884b38a7e04ffeb9bdc91a0a63fe1b")
